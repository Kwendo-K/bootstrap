            ...
            <div class="col-3 bg-primary">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                      <li><a class="dropdown-item" href="#">Kevin Kwendo</a></li>
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div>
                                                <a class="badge rounded-pill bg-danger" href="#" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                                  3+
                                                </a>
                                                <i class="fa fa-bell fa-lg"></i>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                  <li><a class="dropdown-item" href="#">Please submit your assignment</a></li>
                ...
                <div class="row m-2">
                    <div class="col-7">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <img src="https://docs.oracle.com/cd/E29633_01/CDMAA/img/ba_br_arpu.png" alt="Loading" width="500" height="320" >
                            </div>
                        </div>
                ...
                <div class="row m-2">
                    ...
                    <div class="col-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="">
                                    <img src="" alt="Loading" width="500" height="270">
                                </a>
                            </div>
                        </div>
    
                    </div>
                    <!--code for a column containing alert cards and list items-->
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-2">
